...
public class MotionProfileExample {
	 ...
	 * timeout. Getting time-stamps would cert ainly work too, this is just
	 ...
	 */
	public MotionProfileExample(TalonSRX talon, String file) {
		_talon = talon;
		_fileName = file;
		/*
	...
	private void startFilling() {
		...
		profile.Parse(_fileName);
		startFilling(profile.Points, profile.Points.length);
	}
